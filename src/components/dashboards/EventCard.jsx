...
const EventCard = ({ 
  ...
  // Fonction pour déterminer la couleur du consensus
      ...
      <div className="flex items-start justify-between mb-3">
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            <span className={`px-2 py-0.5 text-xs rounded-full ${getConsensusColor(event.consensus)}`}>
              {event.category}
            </span>
      ...
      <div className="space-y-3">
        <div>
          <div className="flex justify-between text-sm text-gray-500 mb-1">
            ...
            <span className="font-semibold">{event.consensus}%</span>
          </div>
